...
public class Menu {
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch (opcao) {
			case 1:
				System.out.println(Cores.TEXT_RESET + "Criar Conta\n");
			...
			case 2:
				...
				break;
			case 3:
				System.out.println(Cores.TEXT_RESET + "Consultar dados da Conta por número\n");
				...
				break;
			case 4:
				System.out.println(Cores.TEXT_RESET + "Atualizar dados da Conta\n");
			...
			case 5:
				...
				break;
			case 6:
				System.out.println(Cores.TEXT_RESET + "Saque\n");
				...
				break;
			case 7:
				System.out.println(Cores.TEXT_RESET + "Depósito\n");
